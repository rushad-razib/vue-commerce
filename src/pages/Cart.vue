                        ...
                        <tr class="shadow-md outline-1 outline-gray-200">
                            <td class="px-4 md:px-10 py-6 align-middle text-sm font-normal text-gray-700 whitespace-nowrap">
                                <div class="flex items-center gap-x-5">
                                    <img :src="product" alt="product-img" class="hidden md:block w-1/4">
                                    <h1 class="pl-4 font-pop font-normal text-[16px] leading-6 text-black">LCD Monitor</h1>
                                </div>
                            </td>
                            <td class="pl-10 w-1/6 font-pop font-normal text-[16px] leading-6 py-6 whitespace-nowrap">79 BDT</td>
                            <td class="pl-10 w-1/6 py-6 font-pop font-normal text-[16px] leading-6 whitespace-nowrap">
                                <div class="w-full md:w-1/2 flex items-center justify-evenly p-3 bg-gray-100 border border-[rgba(0,0,0,0.4)] rounded cursor-pointer select-none gap-x-2">
                                        ...
                                        <span class="text-end quantity font-pop font-normal text-[16px] leading-6">1</span>
                            ...
                            <td class="pl-10 w-1/6 font-pop font-normal text-[16px] leading-6 whitespace-nowrap">79 BDT</td>
        ...
        <div class="container py-10 md:pt-[113px]">
            <div class="w-full md:w-1/3 ms-auto">
                <div class="flex flex-col outline-1 md:outline-[1.5] outline-black rounded py-8 px-6 gap-y-6">
                    ...
                    <button class="px-4 md:px-12 py-2 md:py-4 font-pop font-medium text-[16px] leading-6 border rounded bg-[#DB4444] text-white border-white hover:bg-white hover:text-[#DB4444] hover:border-[#DB4444] duration-300">Proceed to checkout</button>
                </div>
            </div>
        </div>
    </section>
